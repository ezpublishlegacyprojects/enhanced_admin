...
<input size="2" type="text" name="ContentAttribute_priority[]" value="{$Attributes.number}" class="sort_priority"/>
      </div>
    </th>
</tr>
...
<input type="hidden" name="ContentAttribute_position[]" value="{$Attributes.item.placement}" class="hidden_priority"/>
